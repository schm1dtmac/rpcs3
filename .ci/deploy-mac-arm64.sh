...
wget https://github.com/KhronosGroup/MoltenVK/releases/download/v1.4.0/MoltenVK-macos.tar
tar xvf ./MoltenVK-macos.tar
cp -R "./MoltenVK/MoltenVK/dynamic/dylib/macOS/" "rpcs3.app/Contents/Resources/vulkan/icd.d"
