...
export LDFLAGS
LDFLAGS="-L$BREW_PATH/opt/llvm@$LLVM_COMPILER_VER/lib/c++ -L$BREW_PATH/opt/llvm@$LLVM_COMPILER_VER/lib/unwind -lunwind $(pkg-config --libs --static opencv4 | sed -E "s/-l([A-Za-z0-9_]*)/\/opt\/homebrew\/opt\/opencv4\/lib\/lib\1.a/g")"
